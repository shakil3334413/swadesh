...
class CountermanMessage extends Controller
{
    public function index()
    {
        ...
        return view('backend.page.allmessage.countermanmsg',compact('counterman'));
    }
	public function info()
	{
		$countermanmsg=CountermanMsg::latest()->paginate(20);
		return view('backend.page.allmessage.countermanmsginfo',compact('countermanmsg'));
	}
    ...
    public function store(Request $request)
	{
		...
		return redirect()->route('countermaninfo')->with('success','কাউন্টারম্যানের কাছে মেসেজ সফলভাবে পাঠানো হয়েছে');
	}
