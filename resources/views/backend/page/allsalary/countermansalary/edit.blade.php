...
<div class="row owner-form">
	<div class="col-md-4 mt-5 ml-5">
		<form action="{{route('countermansalary.update',$countermansalary->id)}}" method="post" class="needs-validation" novalidate>
			@csrf
			@method('PUT')
			...
			<div class="form-group">
				...
				<div class="mt-3">
					<span  style="color: green;">সিলেক্ট  করা আছে :&nbsp;{{$countermansalary->shift}}</span>
				</div>
			</div>
			<div class="form-group">
