...
<div class="row">
	<div class="col-md-4 mt-5 ml-5 mb-5">
			<form action="{{route('counter.store')}}" method="post"  class="needs-validation" novalidate>
			@csrf
			<div class="form-group">
				<label for="counter_name">নতুন কাউন্টারের নাম</label>
				<input type="text" class="form-control {{ $errors->has('counter_name') ? ' is-invalid' : '' }} " name="counter_name" id="counter_name" placeholder="কাউন্টার নাম" required>
