...
<div class="row">
	...
	<div class="col-md-5  mb-5">
		<a href="" class="btn btn-info btn-lg">সর্বমোট কাউন্টার  খরচ এর তালিকা দেখুন</a>
	</div>
</div>
<div class="row owner-form">
	<div class="col-md-4 mt-5 ml-5 mb-5">
		<form action="{{route('countercostadd.update',$coutercostlists->id)}}" method="post" class="needs-validation" novalidate>
			@csrf
			@method('PUT')
			...
			<div class="form-group">
				...
				<div class="mt-2">
					<span style="color: green;" >সিলেক্ট করা  আছে :{{$coutercostlists->shift}} </span>
				</div>
			</div>
			<div class="form-group">
