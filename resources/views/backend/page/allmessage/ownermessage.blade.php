...
@section('backend-content')
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">মালিকের কাছে  বার্তা বা মেসেজ পাঠান <span><a href="{{route('ownerinfo')}}" class="btn btn-info btn-lg float-right">মেসেজের তালিকা  দেখুন </a></span></h1>
                        <hr>
                    </div>
                  ...
                  -------------------->
                            <div class="row">
                                <div class="col-md-12">
                                       ...
                                       @endif
                                    <form action="{{ route('ownermsgsend') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
