...
<div class="row">
	<div class="col-md-4">
		<form action="{{route('countercostlist.store')}}" method="post" class="needs-validation" novalidate>
			@csrf
			<div class="form-group">
				<label for="counter_cost">কাউন্টার  খরচ এর নাম  লেখুন</label>
				<input type="text" class="form-control{{ $errors->has('cost_name') ? ' is-invalid' : '' }}" name="counter_cost" id="counter_cost" placeholder="খরচ এর নাম  লেখুন" required>
